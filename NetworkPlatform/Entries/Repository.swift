...
extension Repository: DomainConvertibleType {
    var asDomain: Domain.Repository {
        return Domain.Repository(archived: archived,
                                 cloneUrl: cloneUrl,
                                 createdAt: createdAt,
                                 ...
                                 languages: languages?.asDomain,
                                 license: license?.asDomain,
                                 name: name,
...
extension RepositorySearch: DomainConvertibleType {
    var asDomain: Domain.RepositorySearch {
        return Domain.RepositorySearch(items: items.map { $0.asDomain },
...
extension TrendingRepository: DomainConvertibleType {
    var asDomain: Domain.TrendingRepository {
        return Domain.TrendingRepository(author: author,
                                         name: name,
                                         url: url,
                                         descriptionField: descriptionField,
                                         language: language,
                                         ...
                                         builtBy: builtBy.map { $0.asDomain })
    }
}
