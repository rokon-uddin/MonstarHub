...
//        view.adUnitID = Constants.Keys.adMob.apiKey
...
//        }).disposed(by: rx.disposeBag)
    ...
    func bindViewModel() {
        ...
        viewModel?.appError.asObservable().bind(to: error).disposed(by: rx.disposeBag)
...
extension ViewController {
    ...
    var inset: CGFloat {
        return Constants.Dimensions.inset
    }
