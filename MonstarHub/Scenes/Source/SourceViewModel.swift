...
class SourceViewModel: ViewModel, InputOutType {
    ...
    init(content: Content, services: Services) {
    ...
    func transform(input: Input) -> Output {
        ...
        let historySelected = input.historySelection.map { (_) -> URL? in
            return self.content.value.htmlUrl?.replacingOccurrences(of: "https://github.com", with: Constants.Network.githistoryBaseUrl).url
